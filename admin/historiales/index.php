...
<?php $sel = $con->query("SELECT * FROM historiales ");
  ...
  <div class="col s12">
    <div class="card">
      <div class="card-content">
        <span class="card-title">Historiales Médicos (<?php echo $row ?>) </span>
        <table>
          <thead>
            <th>ID</th>
            <th>Nombre</th>
          ...
          <?php while($f = $sel->fetch_assoc()){ ?>
            <tr>
              ...
              <td><?php echo $f['fecha_ing'] ?></td>
              <td><?php echo $f['fecha_eg'] ?></td>
              ...
              <td>
                ...
                location.href='eliminar_historial.php?id=<?php echo $f['id'] ?>'; })">
